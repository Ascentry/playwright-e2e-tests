...
using Ascentry.E2E.Tests.Fixtures;
using Xunit;
...
namespace Ascentry.E2E.Tests.Sandbox
{
    ...
    public class PublicationSandboxTests : AscentryTestBase, IClassFixture<PublicationSandboxFixture>
    {
        public PublicationSandboxTests(PublicationSandboxFixture fixture) : base(fixture) { }
